    ...
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-neutral-950/80 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <button className="button bg-green-700 px-4 py-2 rounded-lg hover:bg-green-600">
              Cart (0)
            </button>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-5 grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          <div key={i} className="relative overflow-hidden rounded-3xl card shadow-lg bg-neutral-900">
            ...
            <div className="relative p-6 md:p-8 lg:p-10">
              ...
              <span className="button mt-4 bg-green-700 px-4 py-2 rounded-lg hover:bg-green-600 cursor-pointer inline-block">
                {x.c}
              </span>
            </div>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-6 grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <aside className="md:col-span-3 lg:col-span-2 space-y-3 md:sticky md:top-24 self-start">
          <div className="card bg-neutral-900 p-4 rounded-xl">
        ...
        <section className="md:col-span-9 lg:col-span-10">
          {/* Filter Bar */}
          <div className="card bg-neutral-900 p-3 flex flex-wrap items-center gap-3 rounded-xl">
            <div className="text-sm">Filters</div>
            <div className="ml-auto flex items-center gap-2 text-sm">
              <button className="button bg-green-700 px-3 py-1 rounded-lg">Sort: Popular</button>
              <button className="button bg-neutral-800 px-3 py-1 rounded-lg">Price</button>
              <button className="button bg-neutral-800 px-3 py-1 rounded-lg">Strain</button>
              <button className="button bg-neutral-800 px-3 py-1 rounded-lg">Brand</button>
            </div>
          </div>
      ...
      <section id="lab" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-12">
        <div className="card bg-neutral-900 p-8 flex flex-col md:flex-row items-center justify-between gap-6 rounded-xl">
          <div>
            <h3 className="text-2xl font-extrabold">Lab Results</h3>
            <p className="text-white/80 mt-1">
              COAs for every batch—potency, terpenes, and contaminant screens.
            </p>
          </div>
          <span className="button bg-green-700 px-4 py-2 rounded-lg hover:bg-green-600 cursor-pointer">
            View Certificates
          </span>
        </div>
      </section>
      ...
      <section id="wholesale" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-12">
        <div className="card bg-neutral-900 p-8 flex flex-col md:flex-row items-center justify-between gap-6 rounded-xl">
          <div>
            ...
            <p className="text-white/80 mt-1">
              Apply for tiered pricing, net terms, and bulk inventory access.
            </p>
          </div>
          <span className="button bg-green-700 px-4 py-2 rounded-lg hover:bg-green-600 cursor-pointer">
            Apply Now
      ...
      {/* Reviews */}
      <section id="reviews" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-12 pb-16">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={i} className="card bg-neutral-900 p-5 rounded-xl">
      ...
      <footer className="mt-16 border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
          <div>
            ...
            <p className="text-white/80 mt-2">
              Legal THC delivered. Replace copy with compliance text.
            </p>
          </div>
          <div>
        ...
        <div className="text-center text-xs text-white/60 pb-10">
          © {new Date().getFullYear()} Foxy Buds · foxybuds.com
        </div>
      </footer>
    </div>
  );
